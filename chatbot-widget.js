...
function startConversation() {
    fetch('https://chatbot-for-maple-tree-childrens-centre.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-maple-tree-childrens-centre.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzYJo8CNC49Q0ID559E7NIvYB844BfWCtrR6E8zPYQ1Xzz0wP8tTR6fpl88jPonylE9/exec';
